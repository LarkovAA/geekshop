...
from mixin import BaseClassContexMixin
from ordersapp.forms import OrderForm, OrderItemsForm
from ordersapp.models import Order, OrderItem
from product.models import Product


class OrderList(ListView, BaseClassContexMixin):
    model = Order
...
class OrderCreate(CreateView, BaseClassContexMixin):
    model = Order
    fields = []
...
class OrderDelete(DeleteView,BaseClassContexMixin):
    model = Order
    success_url = reverse_lazy('orders:list')
    title = 'GeekShop | Удаление заказ'

class OrderDetail(DetailView, BaseClassContexMixin):
    model = Order
    title = 'GeekShop | Просмотр заказ'
